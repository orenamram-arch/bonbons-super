...
def ai_smart_categorize_and_price(item_name):
    """ניתוח חכם של ה-AI המותאם לשוק בישראל עבור מחירים וקטגוריות מדויקות"""
    name_lower = item_name.strip().lower()
    
    # מאגר רחב ומדויק של מוצרים נפוצים בסופר
    smart_db = {
        # ירקות ופירות
        ...
        "ענבים": ("ירקות ופירות", 22.0), "אבטיח": ("ירקות ופירות", 30.0), "מלון": ("ירקות ופירות", 20.0),
        "תותים": ("ירקות ופירות", 15.0), "פטרוזיליה": ("ירקות ופירות", 4.0), "כוסברה": ("ירקות ופירות", 4.0),
        "שום": ("ירקות ופירות", 15.0), "בטטה": ("ירקות ופירות", 9.0), "קישוא": ("ירקות ופירות", 10.0),
        ...
        "חמאה": ("מוצרי חלב", 8.5), "שמנת": ("מוצרי חלב", 5.5), "שמנת מתוקה": ("מוצרי חלב", 7.5),
        "ביצים": ("מוצרי חלב", 14.0), "ביצים לארג'": ("מוצרי חלב", 14.0), "לבנה": ("מוצרי חלב", 16.0),
        "גבינת עיזים": ("מוצרי חלב", 22.0), "בולגרית": ("מוצרי חלב", 18.0), "פטה": ("מוצרי חלב", 18.0),

        # בשר ודגים
        "עוף": ("בשר ודגים", 35.0), "חזה עוף": ("בשר ודגים", 38.0), "שוקיים": ("בשר ודגים", 32.0),
        "בשר": ("בשר ודגים", 65.0), "בשר טחון": ("בשר ודגים", 50.0), "סטייק": ("בשר ודגים", 85.0),
        "דג": ("בשר ודגים", 45.0), "סלמון": ("בשר ודגים", 90.0), "אמנון": ("בשר ודגים", 35.0),
        "טונה": ("בשר ודגים", 7.5), "שימורי טונה": ("בשר ודגים", 25.0), "נקניק": ("בשר ודגים", 22.0),
        "קבב": ("בשר ודגים", 45.0), "הבורגר": ("בשר ודגים", 45.0), "שניצל": ("בשר ודגים", 40.0),

        # מאפים
        "לחם": ("מאפים", 8.5), "לחם אחיד": ("מאפים", 8.5), "לחם פרוס": ("מאפים", 10.0),
        "חלה": ("מאפים", 12.0), "פיתות": ("מאפים", 15.0), "פיתה": ("מאפים", 15.0),
        "בורקס": ("מאפים", 25.0), "עוגה": ("מאפים", 30.0), "לחמנייה": ("מאפים", 3.0),
        "לחמניות": ("מאפים", 15.0), "בגט": ("מאפים", 6.0), "רוגלך": ("מאפים", 20.0),

        # חומרי ניקוי ופארם
        "אקונומיקה": ("חומרי ניקוי", 10.0), "סבון": ("חומרי ניקוי", 12.0), "סבון כלים": ("חומרי ניקוי", 9.0),
        "שמפו": ("חומרי ניקוי", 18.0), "נייר טואלט": ("חומרי ניקוי", 32.0), "נוזל כלים": ("חומרי ניקוי", 9.0),
        "מגבונים": ("חומרי ניקוי", 8.0), "מרכך כביסה": ("חומרי ניקוי", 22.0), "אבקת כביסה": ("חומרי ניקוי", 35.0),
        "משחת שיניים": ("חומרי ניקוי", 12.0), "מטאטא": ("חומרי ניקוי", 25.0), "שקיות אשפה": ("חומרי ניקוי", 12.0),

        # חטיפים וממתקים
        "שוקולד": ("חטיפים וממתקים", 6.5), "במבה": ("חטיפים וממתקים", 5.0), "ביסלי": ("חטיפים וממתקים", 5.0),
        "עוגיות": ("חטיפים וממתקים", 12.0), "במבה ענקית": ("חטיפים וממתקים", 14.0), "דورיטוס": ("חטיפים וממתקים", 6.0),
        "סוכריות": ("חטיפים וממתקים", 8.0), "מסטיק": ("חטיפים וממתקים", 5.0), "וופלים": ("חטיפים וממתקים", 7.0),

        # שימורים ויבשים
        "אורז": ("שימורים ויבשים", 10.0), "פסטה": ("שימורים ויבשים", 6.5), "שמן": ("שימורים ויבשים", 12.0),
        "שמן זית": ("שימורים ויבשים", 35.0), "קמח": ("שימורים ויבשים", 6.0), "סוכר": ("שימורים ויבשים", 6.5),
        "מלח": ("שימורים ויבשים", 3.5), "רסק עגבניות": ("שימורים ויבשים", 5.0), "חומוס": ("שימורים ויבשים", 9.0),
        "מלפפון חמוץ": ("שימורים ויבשים", 8.0), "תירס גמדי": ("שימורים ויבשים", 7.0), "שימורי תירס": ("שימורים ויבשים", 6.5),
        "קפה": ("שימורים ויבשים", 28.0), "תה": ("שימורים ויבשים", 18.0), "דגנים": ("שימורים ויבשים", 22.0)
    }
    ...
    # ניתוח הקשר חכם (Semantic Categorization) אם המוצר לא נמצא במאגר המדויק
    if any(w in name_lower for w in ["מלפפון", "עגבנייה", "בצל", "תפוח", "בננה", "גזר", "פלפל", "לימון", "חסה", "תפוח אדמה", "אבוקדו", "פרי", "ירק", "עגבניה"]):
        return "ירקות ופירות", 10.0
    elif any(w in name_lower for w in ["חלב", "גבינה", "יוגורט", "חמאה", "שמנת", "מעדן", "ביצים"]):
        return "מוצרי חלב", 8.0
    elif any(w in name_lower for w in ["בשר", "עוף", "דג", "סטייק", "שניצל", "קבב", "הבורגר", "נקניק"]):
        return "בשר ודגים", 45.0
    elif any(w in name_lower for w in ["לחם", "חלה", "פיתה", "בורקס", "עוגה", "מאפה", "לחמנייה", "בגט"]):
        return "מאפים", 10.0
    elif any(w in name_lower for w in ["ניקוי", "סבון", "שמפו", "נייר", "מגבונים", "כביסה", "אקונומיקה", "מרכך"]):
        return "חומרי ניקוי", 15.0
    elif any(w in name_lower for w in ["שוקולד", "במבה", "ביסלי", "עוגיות", "חטיף", "סוכריה", "מסטיק"]):
        return "חטיפים וממתקים", 7.0
    elif any(w in name_lower for w in ["אורז", "פסטה", "שמן", "קמח", "סוכר", "מלח", "שימורי", "רסק", "קפה", "תה"]):
        ...
        if st.button("🔍 נתח תמונה וחלץ פריטים"):
            with st.spinner("מנתח את התמונה ומזהה מוצרים..."):
                ...
                for sim_item in simulated_items:
                    cat, price = ai_smart_categorize_and_price(sim_item)
                    st.session_state.shopping_list.append({
                        "name": sim_item,
                        "quantity": 1,
                        "category": cat,
